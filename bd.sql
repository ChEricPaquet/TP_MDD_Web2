...
('Fripons','Fripons.png','One big guy two littles girls.', 1),
('Fut à barbare','FutABarbare.png','Un sort qui roule un fut et inovque un barabre a la fin de sa trajectoire'),
('Fut à gobelins','FutAGobelin.png','Un sort qui invoque 3 gobelins où il attérit'),
